...
// Whether the region should display a "new" badge ("new" is not precisely
// defined, just used to trigger a badge in some clients)
KAPPS_REGIONS_EXPORT
bool KARRegionNewBadge(const KARRegion *pRegion);
